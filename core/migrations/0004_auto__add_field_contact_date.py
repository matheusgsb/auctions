...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.date'
        db.add_column(u'core_contact', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 8, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.date'
        db.delete_column(u'core_contact', 'date')

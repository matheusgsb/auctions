...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Auction.min_price'
        db.delete_column(u'core_auction', 'min_price')


    def backwards(self, orm):
        # Adding field 'Auction.min_price'
        db.add_column(u'core_auction', 'min_price',
    ...
    models = {
        ...
        u'core.auction': {
            ...
            'date_begin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.bid': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.customuser': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),

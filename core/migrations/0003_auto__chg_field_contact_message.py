...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_contact', 'message', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Contact.message'
        db.alter_column(u'core_contact', 'message', self.gf('django.db.models.fields.CharField')(max_length=1000))

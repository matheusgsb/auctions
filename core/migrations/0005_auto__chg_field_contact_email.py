...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_contact', 'email', self.gf('django.db.models.fields.EmailField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Contact.email'
        db.alter_column(u'core_contact', 'email', self.gf('django.db.models.fields.EmailField')(max_length=25))
